...
ass = analytic_server("rhe701.fyre.ibm.com",9080,False,"admin","test")
...
modeling = ass.create_pipeline().read_datasource("DRUG1N").select("lambda x: x.Age>10").derive("ratio","lambda x:x.Na/x.K").tree(conf_tree,conf_outcon).run()
"""
